...
folder_T0_0 = 'data/high_resolution'
folder_T0_2 = 'data/high_resolution'
Tab    = 12
...
for i in index:
    ...
    config = read_config(folder_T0_0, 'T0_0')
...
for i in index:
    ...
    config = read_config(folder_T0_2, 'Tab_12')
    ab_params  = {'p': p, 'T0': T0, 'Tab': Tab}
...
sns.despine()
fig.savefig(f"figs/mutation_average/mutation_average_parameters.png", dpi=300)